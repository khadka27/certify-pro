        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <div className="bg-gradient-to-r from-emerald-50 to-teal-50 p-8 rounded-lg border-l-4 border-emerald-600 mb-8">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                <p className="text-sm font-semibold text-emerald-700 uppercase mb-1">Product</p>
                <p className="text-xl text-gray-800">{data.productName}</p>
              </div>
              <div>
                <p className="text-sm font-semibold text-emerald-700 uppercase mb-1">Certificate No</p>
          ...
          <div className="bg-emerald-600 text-white p-6 rounded-lg inline-block self-start">
            <p className="text-xs uppercase tracking-wider mb-1 opacity-80">Certified by</p>
